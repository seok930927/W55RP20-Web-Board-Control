...
void GPIO_Configuration_IRQ(uint16_t GPIO_Pin, USER_IO_IRQ GPIO_IRQ_Event) {
    uint8_t dev_irq_event;

    switch (GPIO_IRQ_Event) {
    case IO_IRQ_LOW :
        dev_irq_event = GPIO_IRQ_LEVEL_LOW;
        break;
    case IO_IRQ_HIGH :
        dev_irq_event = GPIO_IRQ_LEVEL_HIGH;
        break;
    case IO_IRQ_FALL :
        dev_irq_event = GPIO_IRQ_EDGE_FALL;
        break;
    case IO_IRQ_RISE :
        dev_irq_event = GPIO_IRQ_EDGE_RISE;
        break;
    }
